...
public interface IChatService
{
    ...
    Task MarkAsReadAsync(MarkAsReadRequest req, Guid userId, CancellationToken ct = default);
    Task<ChatMemberDto> AddMemberAsync(AddMemberRequest req, Guid callerId, CancellationToken ct = default);
    Task RemoveMemberAsync(Guid chatId, Guid targetUserId, Guid callerId, CancellationToken ct = default);
